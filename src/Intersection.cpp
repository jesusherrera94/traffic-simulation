...
void Intersection::addVehicleToQueue(std::shared_ptr<Vehicle> vehicle)
{
    ...
    {
        std::cout << "Intersection #" << _id << ": Traffic light is green. Vehicle #" << vehicle->getID() << " is entering." << std::endl;
    }
    else
    {
        std::cout << "Intersection #" << _id << ": Traffic light is red. Vehicle #" << vehicle->getID() << " is waiting." << std::endl;
